...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        xs:   "0 1px 2px rgba(22,26,31,0.04)",
        sm:   "0 1px 3px rgba(22,26,31,0.06)",
        md:   "0 4px 14px rgba(22,26,31,0.08)",
        lg:   "0 12px 32px rgba(22,26,31,0.12)",
        xl:   "0 20px 52px rgba(22,26,31,0.16)",
        gold: "0 0 0 3px rgba(255,66,102,0.24), 0 0 20px rgba(255,66,102,0.12)",
      },
    },
  },
