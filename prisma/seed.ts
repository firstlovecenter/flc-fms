...
async function main() {
  ...
  const pricingData = [
    ...
    { facilityId: auditorium.id, category: "CHURCH_SERVICE", pricePerHour: 500, pricePerDay: 0, freeDays: [0], description: "Free on Sundays for church services" },
    { facilityId: auditorium.id, category: "WEDDING", pricePerHour: 800, pricePerDay: 5000, description: "Premium wedding package" },
    { facilityId: auditorium.id, category: "CONCERT", pricePerHour: 1000, pricePerDay: 7000, description: "Concert/performance rate" },
    { facilityId: auditorium.id, category: "CONFERENCE", pricePerHour: 600, pricePerDay: 4000, description: "Corporate conference" },
    
    // Conference Hall - Business focus
    { facilityId: confHall.id, category: "MEETING", pricePerHour: 150, description: "Standard meeting rate" },
    { facilityId: confHall.id, category: "WORKSHOP", pricePerHour: 200, pricePerDay: 1000, description: "Workshop/training" },
    { facilityId: confHall.id, category: "CONFERENCE", pricePerHour: 250, pricePerDay: 1500, description: "Full conference" },
    
    // Fellowship Hall - Community events
    { facilityId: fellowship1.id, category: "CHURCH_SERVICE", pricePerHour: 150, freeDays: [0, 3], description: "Free on Sundays and Wednesdays for church activities" },
    { facilityId: fellowship1.id, category: "BIRTHDAY_PARTY", pricePerHour: 180, pricePerDay: 900, description: "Party package" },
    { facilityId: fellowship1.id, category: "MEETING", pricePerHour: 120, description: "Community meetings" },
    { facilityId: fellowship1.id, category: "REHEARSAL", pricePerHour: 100, description: "Rehearsal space" },
  ];
