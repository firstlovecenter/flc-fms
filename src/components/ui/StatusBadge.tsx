...
const STATUS_MAP: Record<string, StatusConfig> = {
  ...
  COMPLAINT:           { label: "Complaint",   icon: AlertCircle,  tone: "danger" },
  FEEDBACK:            { label: "Feedback",    icon: CircleDot,    tone: "info" },
  SUGGESTION:          { label: "Suggestion",  icon: CheckCircle2, tone: "success" },
  OPEN:              { label: "Open",        icon: CircleDot,    tone: "orange", pulse: true },
  IN_REVIEW:         { label: "In Review",   icon: AlertCircle,  tone: "warning" },
