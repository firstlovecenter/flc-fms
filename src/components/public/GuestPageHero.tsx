  ...
  return (
    <section
      className={cn(
        ...
        "border-[rgba(200,163,90,0.34)] dark:border-[var(--border)] shadow-lg text-white",
        className
      )}
    >
      <p className="text-eyebrow text-white/65 mb-2">{eyebrow}</p>
      <h1 className="font-display text-[clamp(1.75rem,3vw,2.5rem)] leading-[1.1]">{title}</h1>
      <p className="text-body-sm text-white/75 mt-2 max-w-[700px]">{description}</p>
